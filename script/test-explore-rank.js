/** 探索三赛道排序单测：从 memo-home.html 提取排序代码块，跑 6 场景（node script/test-explore-rank.js） */
const fs = require('fs');
...
expect('场景1 三赛道循环',
  run([mkPhoto('付费甲',5,now-86400*3),mkPhoto('付费乙',3,now-86400*3),mkPhoto('高赞王',100,now-86400*3),mkPhoto('次赞兄',50,now-86400*3),mkPhoto('新人甲',0,now-7200),mkPhoto('新人乙',0,now-3600),mkPhoto('老油条',20,now-86400*10)],'测1',{boostAuthors:['付费甲','付费乙']}),
  ['付费甲','高赞王','新人乙','付费乙','次赞兄','新人甲','老油条']);
expect('场景2 入组锁位（重发不刷新）',
  run([mkPhoto('新人甲',0,now-7200),mkPhoto('新人甲',0,now-1800),mkPhoto('新人乙',0,now-3600)],'测2'),
  ['新人乙','新人甲']);
expect('场景3b 72h霸榜惩罚即刻生效',
  run([mkPhoto('霸榜者',0,now-3600),mkPhoto('老实人',30,now-86400*5)],'测3',{crown:{['explore_crown_测3']:JSON.stringify({霸榜者:{since:now-73*3600}})}}),
  ['老实人','霸榜者']);
expect('场景4 本地boost后买靠前+三赛道穿插',
